...
<div align="right"><b><font color="#6b80a1"><?php echo $this->lang->line('Local time');?> </font><?php echo show_date(get_est_time()); ?></b></div>
	  ...
	  <?php if(!isset($innerClass)) { $innerClass=''; } ?>
		<ul>
			<li class="<?php if(isset($innerClass1)) { echo $innerClass1;}?>"><a href="<?php echo site_url('account');?>"><span>Account Summary</span></a></li>
			<li class="<?php if(isset($innerClass1)) { echo $innerClass1;}?>"><a href="<?php echo site_url('buyer/editProfile');?>"><span>Edit Profile</span></a></li>
			<li class="<?php if(isset($innerClass1)) { echo $innerClass1;}?>"><a href="<?php echo site_url('buyer/viewMyProjects');?>"><span>View My Products</span></a></li>
