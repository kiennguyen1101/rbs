  ...
  <div class="clsSettings">
    ...
    <div class="clsMidWrapper">
      ...
      <div class="clsTop clsClearFixSub">
		...
		<div class="clsTitle">
          <h3><?php echo $this->lang->line('Search Bid Projects'); ?></h3>
        </div>
      </div>
      ...
      <div class="clsTable">
       <table width="700" class="table">
		 <form name="searchTransaction" action="<?php echo admin_url('skills/searchBids');?>" method="post">
		     ...
		     <tr><td><label><b><?php echo $this->lang->line('Enter Project Id'); ?></b></label></td><td><input type="text" name="projectid" id="projectid" /></td></tr>
