  ...
  <div class="clsSettings">
    ...
    <div class="clsMidWrapper">
      ...
      <div class="clsTop clsClearFixSub">
        <div class="clsTitle">
          <h3><?php echo $this->lang->line('Edit Affiliates Questions'); ?></h3>
        </div>
        <div class="clsNav">
          <ul>
     ...
     <table width="700" class="table">
    	<form action="<?php echo admin_url('affiliateSettings/editQuestions'); ?>" name="manageQuestions" id="manageQuestions" method="post">  <?Php 
		...
		foreach($list as $res) 
		 {
			foreach($res->result() as $rec)
			  ...
			  <tr><td><label><b><?php echo $this->lang->line('Id'); ?></b></label></td><td><input type="text" name="questionid[]" value="<?php echo $rec->id; ?>" readonly="yes" /></td></tr>
		 ...
		 <tr><td></td><td><input type="submit" name="editQuestions" id="editQuestions" value="<?php echo $this->lang->line('Submit');?>" class="clsSubmitBt1" /></td></tr>
		</form>
		</table>
      </div>
	  <!--PAGING-->
...
function formSubmit()
{
	document.manageQuestions.submit();
