  ...
  <div class="clsSettings">
    ...
    <div class="clsMidWrapper">
      ...
      <div class="clsTop clsClearFixSub">
		...
		<div class="clsTitle">
          <h3><?php echo $this->lang->line('Search Affiliate Sales'); ?></h3>
        </div>
      </div>
      ...
      <div class="clsTable">
       <table width="700" class="table">
		 <form name="searchTransaction" action="<?php echo admin_url('affiliateSettings/searchAffiliateSales');?>" method="post">
		    
		     <tr><td><label><b><?php echo $this->lang->line('Enter Affiliate Sale Id'); ?></b></label></td><td><input type="text" name="saleid" id="saleid" /></td></tr>
