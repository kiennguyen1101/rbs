...
<div id="main">
  <div class="clsSettings">
    <div class="clsMainSettings">
     ...
     <form method="post" action="<?php echo admin_url('affiliateSettings/getAffiliatePayment')?>">
	  <table class="table1" cellpadding="2" cellspacing="0">
       ...
       <tr>
         <td class="clsName"><?php echo $this->lang->line('user_type');?><span class="clsRed">*</span></td>
          <td class="clsTextBox"><input class="clsTextBox" type="text" name="user_type" value="<?php  if(isset($affiliates['user_type'])) echo $affiliates['user_type']; else if($this->input->post('user_type') == '') echo $userType; ?>" readonly="true"/>
     ...
     <tr align="center">
	 		<td></td>
          <td><input type="submit" class="clsSubmitBt1" value="<?php echo $this->lang->line('submit'); ?>"  name="regularProjectSettings"/></td>
        </tr>
