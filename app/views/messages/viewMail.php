						...
						<?php 
                          ...
                          <form action="<?php echo site_url('messages/searchMail'); ?>" method="post">
							...
							if($logged_userrole == '1')	
							   { ?>
                                <option name="user" value="user">Provider</option>
                                <?php
							   } ?>
                              </select>
                                    ...
                                    <td class="<?php echo $class2; ?>">
                                      <?php $len=strlen($Inbox->message); 
														if($len < 35 )
														   ...
														   { ?>
                                      <div class="" onClick="return SwitchMenu('sub<?php echo $res = rand(5, 10000);?>')"> <a href="<?php //echo site_url('project/view/'.$Inbox->project_id); ?>"><?php echo substr($Inbox->message,0,35).'...';  ?></a></div>
                                      <?php  
														   }
													 ...
													 ?>
                                      <a href="<?php echo site_url('messages/messageReply/'.$Inbox->id); ?>" style="color:#0000FF">Reply</a>
                                      </p>
                                ...
                                <?php $len=strlen($outbox->message); 
											if($len < 35 )
										      ...
										      echo $outbox->message; 
											   ...
											   { ?>
                                <div class="" onClick="return SwitchMenu('sub<?php echo $res = rand(5, 10000);?>')"> <?php echo substr($outbox->message,0,35).'...';  ?></div>
                                <?php  
											   }   
										 ?>
                                </a>
                              ...
                              <td class="<?php echo $class2; ?>">
                                <?php 
										...
										if($len < 30)
										   ...
										   { ?>
                                <div class="" onClick="return SwitchMenu('sub<?php echo $res = rand(5, 10000);?>')"> <a href="<?php //echo site_url('project/view/'.$outbox->id); ?>"><?php echo substr($outbox->message,0,30).'...';  ?></a></div>
                                <?php  
										   }
									 ?>
