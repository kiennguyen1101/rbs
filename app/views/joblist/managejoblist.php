              ...
              <div class="inner_b">
                <div class="inner_l">
                  <div class="inner_tl">
					...
					<form method="post" action="<?php echo site_url('joblist/manageJoblist'); ?>"  enctype="multipart/form-data" >
                              ...
                              <h3><span class="clsOptDetial"><?php echo $this->lang->line('Required JobList Details...');?></span></h3>
                                ...
                                <li>
                                  ...
                                  <p>
                                   <input name="projectName" value="<?php echo $postSimilarall->project_name; ?>" maxlength="50" size="50" type="text" readonly="yes"/>
								   <input type="hidden" name="projectid" value="<?php echo $postSimilarall->id; ?>"/>
								 
									<input name="update" id="update" value="<?php echo 0;?>" type="hidden"/> 
                                ...
                                <li>
                                  <h5><?php echo $this->lang->line('Describe the project in detail:');?></h5>
									<p>
									  <textarea rows="10" name="description" cols="70" readonly="yes"><?php  echo  strip_tags($postSimilarall->description); ?></textarea>
									</p>
