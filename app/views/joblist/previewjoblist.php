                      ...
                      <div class="inner_bl">
                        <div class="inner_br">
                          <div class="cls100_p">
							...
							<p><span><?php echo $this->lang->line('Project Creator:');?></span><a href="<?php echo site_url('buyer/viewProfile/'.$loggedInUser->id);?>"><?php echo $loggedInUser->user_name; ?></a><?php $condition1=array('subscriptionuser.username'=>$loggedInUser->id);
							...
							<p><span><?php echo $this->lang->line('Job Type:');?></span><?php echo $project->project_categories;?></p>
							 ...
							 <h2> <?php echo $this->lang->line('Preview Joblist Project');?> </h2>
							<h3><span class="clsFeatured"><?php echo $this->lang->line('Joblist Details');?></span></h3>
							 
							<p><span><?php echo $this->lang->line('Project');?>:</span> <?php echo $project->project_name; ?></p>
							<p><span><?php echo $this->lang->line('Status:');?></span>
							<?php echo 'Pending'?></p>
							<p><span><?php echo $this->lang->line('Salary:');?></span>$<?php echo $project->salary; ?></p>
							<p><span><?php echo $this->lang->line('Created:');?></span><?php echo get_date($project->created); ?></p>
							<p><span><?php echo $this->lang->line('Closes:');?></span><?php echo get_date($project->enddate);
											?> left<?php echo '<b style="color:red;">('.days_left($project->enddate,$project->id).'</b>';?>)</p>
							...
							<p><span><?php echo $this->lang->line('Description:');?></span><?php echo $project->description; ?></p>
							<p><span><?php echo $this->lang->line('Contact:');?></span><?php echo $project->contact;?></p>
							<?php } ?>
						   </div>
						 </div>
						</div>
