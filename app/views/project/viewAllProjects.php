                            ...
                            <table cellspacing="1" cellpadding="2" width="96%">
                              <tbody>
                                <tr>
								 ...
								 $order = 'ASC';
								  ?>
                                  <td width="250" class="dt"><a href="<?php echo site_url('project/viewAllProjects/'.$type."/".$page."/project_name/".$order);?>"> <?php echo $this->lang->line('Project Name'); ?> </a>
                                    <?php
                                  ...
                                  <td width="60" class="dt"><a href="<?php echo site_url('project/viewAllProjects/'.$type."/".$page."/budget_max/".$order);?>"> <?php echo $this->lang->line('Budget'); ?> </a>
                                    <?php
                                  ...
                                  <?php } 
										  ...
										  {
										  ?>
                                  <td class="dt"><a href="<?php echo site_url('project/viewAllProjects/'.$type."/".$page."/created/".$order);?>"> <?php echo $this->lang->line('Start Date'); ?> </a>
                                    <?php
