							 ...
							 <form method="post" action="<?php echo site_url('project/awardBid');?>">
								...
								<table cellpadding="2" cellspacing="1" width="96%">
								  ...
								  <td width="10%" class="dt">
									<?php echo $this->lang->line('Pick');?></td> <td width="20%" class="dt"> <?php echo $this->lang->line('Programmers');?> </td><td width="20%" class="dt"> <?php echo $this->lang->line('Bid');?> </td><td width="20%" class="dt"> <?php echo $this->lang->line('Delivery Time');?> </td><td width="20%" class="dt"> <?php echo $this->lang->line('Time of Bid');?> </td></tr>
								  <?php
								  ...
								  <tr class="<?php echo $class; ?>">
									...
									<td class="<?php echo $class2; ?>"> <a href="<?php echo site_url('programmer/viewProfile/'.$bid->user_id);?>"><?php echo $bid->user_name;?></a>
