                                          ...
                                          <div class="cls100_p ">
                                            <div class="clsprogram">
                                              ...
                                              <div class="clsBanners">
                                                ...
                                                <p>
                                                  <textarea cols="70" rows="3" name="select1"><a href="<? echo base_url(); ?>index.php/affiliate/ref/<? if(isset($loggedInUser->user_name)) echo $loggedInUser->user_name; else echo 'USER'; ?>"><IMG SRC="<? echo base_url(); ?>app/css/images/banner_4_728x90.jpg" WIDTH="728" HEIGHT="90" BORDER="0" ALT="Outsource your programming projects at ifindaudio.com today - Free signup"></a></textarea>
                                                </p>
                                                <p><a href="#">Select HTML</a></p>
                                              </div>
                                              <div class="clsBanners">
                                              ...
                                              <div class="clsBanners">
                                                ...
                                                <p>
                                                  <textarea cols="70" rows="3" name="select1"><a href="<? echo base_url(); ?>index.php/affiliate/ref/<? if(isset($loggedInUser->user_name)) echo $loggedInUser->user_name; else echo 'USER'; ?>"><IMG SRC="<? echo base_url(); ?>app/css/images/banner_8_120x600.jpg" WIDTH="120" HEIGHT="600" BORDER="0" ALT="Thousands of experts bid on your personal project at ifindaudio.com"></a></textarea>
                                                </p>
                                                <p><a href="#">Select HTML</a></p>
                                              </div>
                                            </div>
