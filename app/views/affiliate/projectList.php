                                            ...
                                            <div class="cls100_p ">
                                              <div class="clsprogram">
                                                <div class="clsJavaScript">
                                                  ...
                                                  <br/>
                                                  <p>
                                                    <textarea cols="70" rows="4" name="select1"><script src="<?phpecho site_url(); ?>/affiliate/projectList/<?phpif(isset($this->loggedInUser->user_name)) echo $this->loggedInUser->user_name; else echo 'USER'; ?>"></script>
</textarea>
                                                  </p>
                                                  <br/>
