                                            ...
                                            <div class="cls100_p ">
                                              <div class="clsprogram">
                                                <div class="clsTextFeed">
                                                  ...
                                                  <br/>
                                                  <p><?phpecho site_url(); ?>/affiliate/textFeed/<font color="red">Y</font>/<font color="red"><?phpif(isset($this->loggedInUser->user_name)) echo $this->loggedInUser->user_name; else echo "USER";?>
                                                    </font></span></p>
                                                  <br/>
