                            ...
                            <table width="650" cellspacing="1" cellpadding="2">
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="dt1"> <b>$2-$2.40</b> plus <b><?php if(isset($affiliate['buyer_affiliate_fee'])) echo $affiliate['buyer_affiliate_fee']; ?>%</b> of fee we charge their selected Seller (Min: $<?php if(isset($affiliate['buyer_min_amount'])) echo $affiliate['buyer_min_amount']; ?>)<br /><br />Minimum payout per project: <b>$<?php if(isset($affiliate['buyer_min_payout'])) echo $affiliate['buyer_min_payout']; ?>.00</b><br />Maximum payout per project: <b><?php if(isset($affiliate['buyer_max_payout'])) echo $affiliate['buyer_max_payout']; ?></b></td>
                                  <td class="dt1"><b><?php if(isset($affiliate['seller_affiliate_fee'])) echo $affiliate['seller_affiliate_fee']; ?>%</b> of fee charged to Seller (Min: $<?php if(isset($affiliate['seller_min_amount'])) echo $affiliate['seller_min_amount']; ?>), plus $0.50-$0.60 (<?php if(isset($affiliate['seller_affiliate_fee'])) echo $affiliate['seller_affiliate_fee']; ?>% of Buyer's fee).<br /><br />Minimum payout per project: <b>$<?php if(isset($affiliate['seller_min_payout'])) echo $affiliate['seller_min_payout']; ?>.00</b><br />Maximum payout per project: <b><?php if(isset($affiliate['seller_max_payout'])) echo $affiliate['seller_max_payout']; ?></b></td>
                                </tr>
                                <tr>
