                          ...
                          <div class="cls100_p">
							...
							?>
                                <tr>
								  ...
								  <?php $buyer = getUserInfo($reviewDetail->buyer_id);?>
								  
							<?php 
							$chj = getAvgReview($reviewDetail->buyer_id,'buyer_id');
							echo $buyer->user_name;
							?>
							<img src="<?php echo image_url('rating_'.$chj.'.gif');?>" />( <a href="<?php echo site_url('buyer/review/'.$buyer->id);?>">
							<?php echo getNumReviews($reviewDetail->buyer_id,'buyer_id')." reviews";?></a> )</td>		
