                                            ...
                                            <div class="clsInnerCommon clsFormSpan">
                                                ...
                                                <form method="post" action="<?php echo site_url('seller/editProfile'); ?>" enctype="multipart/form-data">
                                                    ...
                                                    <?php if (form_error('name'))
                                                        echo '<p><span>&nbsp;</span>' . form_error('name') . '<br> </p>'; ?>
...
<?php if (form_error('notify_message'))
    echo '<p><span>&nbsp;</span>' . form_error('notify_message') . '<br></p>'; ?>
...
<?php $userContact = $userContactInfo->row(); ?>  <h3><span class="clsOptContact"><?php echo $this->lang->line('op_contact_details'); ?></span><?php echo $this->lang->line('('); ?><a href="<?php echo site_url('page/privacy_policy'); ?>"><?php echo $this->lang->line('privacy_policy'); ?></a><?php echo $this->lang->line(')'); ?></h3>
                                                    <p><span> <?php echo $this->lang->line('MSN:'); ?></span> 
                                                        <input type="text" name="contact_msn" value="<?php
if (isset($userContact->msn)) {
...
?>" size="25"/>
                                                    ...
                                                    <p> <span > <?php echo $this->lang->line('Gtalk:'); ?></span>
                                                        <input name="contact_gtalk" type="text" id="contact_gtalk" value="<?php
                                                        if (isset($userContact->gtalk)) {
...
?>" size="25"/>
                                                    ...
                                                    <p> <span > <?php echo $this->lang->line('Yahoo:'); ?></span>
                                                        <input name="contact_yahoo" type="text" id="contact_yahoo" value="<?php
                                                               if (isset($userContact->yahoo)) {
...
?>" size="25"/>
                                                    ...
                                                    <p> <span> <?php echo $this->lang->line('Skype:'); ?></span>
                                                        <input type="text" name="contact_skype" value="<?php
                                                        if (isset($userContact->skype)) {
...
if (count($userCategoryInfo) > 0) {
    ...
    if (isset($categories) and $categories->num_rows() > 0) {
        foreach ($categories->result() as $category) {
            ...
            ?>
                                                                    <input type="checkbox" name="categories[]" value="<?php echo $category->id; ?>" <?php if (in_array($category->id, $ids))
                                                        ...
                                                        <?php if (form_error('categories[]'))
                                                            echo '<p><span>&nbsp;</span>' . form_error('categories[]') . '<br></p>'; ?><br />
                                                    ...
                                                    <p><span><?php echo $this->lang->line('your_average_hourly_rate'); ?></span>
                                                        ...
                                                        <?php if (form_error('rate'))
                                                            echo '<p><span>&nbsp;</span>' . form_error('rate') . '<br></p>'; ?>
                                                    ...
                                                    <p><?php if (form_error('logo'))
                                                        echo '<p><span>&nbsp;</span>' . form_error('logo') . '<br></p>'; ?></p>
...
?></p>
                                                    <p><span><?php echo $this->lang->line('new_project_noti'); ?></span>
                                                        ...
                                                        <select name="notify_project" size="1">
                                                            ...
                                                            <option value="<?php echo $this->lang->line('Instantly'); ?>" <?php if ($userData->project_notify == 'Instantly')
                                                                echo 'selected="selected"'; ?>><?php echo $this->lang->line('Instantly'); ?></option>
                                                            <option value="<?php echo $this->lang->line('Hourly'); ?>" <?php if ($userData->project_notify == 'Hourly')
                                                                echo 'selected="selected"'; ?>><?php echo $this->lang->line('Hourly'); ?></option>
                                                            <option value="<?php echo $this->lang->line('Daily'); ?>"  <?php if ($userData->project_notify == 'Daily')
                                                                echo 'selected="selected"'; ?>><?php echo $this->lang->line('Daily'); ?></option>
                                                        </select></p>

<?php if (form_error('notify_project'))
    echo '<p><span>&nbsp;</span>' . form_error('notify_project') . '<br></p>'; ?>

                                                    <p><span><?php echo $this->lang->line('new_message_noti'); ?></span>

                                                        <select name="notify_message" size="1">
                                                            <option value=""><?php echo $this->lang->line('None'); ?></option>
                                                            <option value="<?php echo $this->lang->line('Instantly'); ?>" <?php if ($userData->message_notify == 'Instantly')
    echo 'selected="selected"'; ?>><?php echo $this->lang->line('Instantly'); ?></option>
                                                            <option value="<?php echo $this->lang->line('Hourly'); ?>" <?php if ($userData->message_notify == 'Hourly')
    echo 'selected="selected"'; ?>><?php echo $this->lang->line('Hourly'); ?></option>
                                                            <option value="<?php echo $this->lang->line('Daily'); ?>"  <?php if ($userData->message_notify == 'Daily')
    echo 'selected="selected"'; ?>><?php echo $this->lang->line('Daily'); ?></option>
                                                        </select> </p>
