                      ...
                      <div class="inner_bl">
                        <div class="inner_br">
                          <div class="cls100_p">
                            <div class="clsInnerCommon">
                             <?php 
							  ...
							  if(is_object($reviewDetails))
							    {
								  ?> 
								  <h2><?php echo $this->lang->line('Feedback for Buyer');?> - <?php echo $reviewDetails->user_name;?></h2>
							   ...
							   <h2><?php echo $this->lang->line('Feedback for Buyer');?> - <?php echo $projectDetails->user_name;?></h2>
							   <form action="" method="post" name="form1">
							  <p><?php echo $this->lang->line('How would you rate the buyer');?> <strong><?php echo $projectDetails->user_name;?></strong> <?php echo $this->lang->line('for the project');?> <strong><?php echo $projectDetails->project_name;?></strong></p>
							 ...
							 <p class="clsEditProfile"><span>  <?php echo $this->lang->line('Rating:');?> </span>
							  ...
							  <p class="clsEditProfile"> <span> <?php echo $this->lang->line('Comment:');?> </span> <textarea id="comment" rows="5" cols="50" name="comment"/></textarea>
							  </p>
							...
							<p class="clsEditProfile"><span> &nbsp;</span>  <input type="submit" value="<?php echo $this->lang->line('Submit');?>" name="reviewBuy" class="clsSmall"/></p>
								  </form>
								  <?php } ?>
                            </div>
                          </div>
