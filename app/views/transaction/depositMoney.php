                ...
                <div class="grey_l">
                  <div class="grey_tl">
					...
					<div class="clsEditProfile clsSitelinks">   
                              <h3><span class="clsDepositFunds"><?php echo $this->lang->line('Deposit Funds');?></span></h3>
							<?php $condition1=array('subscriptionuser.username'=>$loggedInUser->id);
							  ...
							  <p><span><?php echo $this->lang->line('User name :');?></span><?php echo $this->lang->line('user_name'); ?><a class="glow" href="<?php if($loggedInUser->role_id == '1') $res = 'buyer'; else $res = 'programmer'; echo site_url($res.'/viewprofile/'.$loggedInUser->id); ?>"> <?php echo $loggedInUser->user_name?></a><?php if(count($certified1->result())>0)
								{?>
							  ...
							  <p><span><?php echo $this->lang->line('Account Balance:');?></span> $ <?php if(isset($userAvailableBalance)) echo $userAvailableBalance.'.00'; ?></p>
								<form name="depositAmount" action="<?php echo site_url('deposit'); ?>"  method="post">
							  
							  <p><span><?php echo $this->lang->line('Deposit Amount:');?></span> $ <input name="total" size="10" value="<?php if(isset($amount)) echo $amount; else echo set_value('total');?>"  type="text"/>
...
<p>
  <!--<input type="submit" value="Deposit" name="depositMoney" class="clsLogin"/>-->
							...
							<h3><span class="clsPayMethods"><?php echo $this->lang->line('Payment methods');?></span></h3>
                        ...
                        <label><?php echo $this->lang->line('Paypal') ?></label></td>
							...
							<p><input type="submit" value="<?php echo $this->lang->line('Deposit');?>" name="depositMoney" class="clsSmall"/></p>
							</form>
							</div>
							<br />
							<h3><span class="clsDepositTrans"><?php echo $this->lang->line('My Deposit Transactions');?></span></h3>
							<table cellspacing="1" cellpadding="2" width="96%">
                                <tbody><tr>
