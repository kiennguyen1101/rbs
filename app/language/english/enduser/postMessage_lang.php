...
$lang['Note: Only private message to seller']							= '[ Note: Please enter Provider id for private message with comma separate operator ]';
...
$lang['You must be logged in as a seller to post messages on the Project Message Board']	= 'You must be logged in as a Provider to post messages on the Project Message Board';
...
$lang['You must be post project to invite sellers']					                        = 'You must be post project to invite Providers';
$lang['You must be logged to invite sellers']					                            = 'You must be logged to invite Providers';
