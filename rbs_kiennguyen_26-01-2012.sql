...
--
-- Host: localhost
-- Generation Time: Jan 26, 2012 at 06:17 AM
...
CREATE TABLE IF NOT EXISTS `bids` (
  ...
  `same_area` enum('0','1') CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `bids` (`id`, `project_id`, `user_id`, `quantity`, `bid_amount`, `bid_time`, `bid_desc`, `same_area`) VALUES
(4, 1, 2, 10, 100, 1327228838, '', '1');
...
INSERT INTO `product_discount` (`id`, `bids_id`, `discount_percentage`, `discount_at`) VALUES
(1, 4, 5, 5),
(2, 4, 3, 8),
(3, 4, 2, 10);
...
(1, 'Sony Erricsson', '1', 'Holy crap blahb lah nu nu<br/>', 'PHP', 0, 0, 0, 0, 0, 4, 1326703626, 1327627626, 2, '4c8b5926a88ee303cec37d46ab9e3fa8', '0', '0', '0', 1327409789, 0, '', NULL, 0, NULL, '', '', 0, '', 0, 1),
(2, 'Hallelujah', '0', 'Lorem Ipsum Karakatitiaaaaaaaa<br/>', 'PHP', 0, 0, 0, 0, 0, 5, 1327543407, 1328148207, 0, '', '0', '0', '0', 0, 0, '', NULL, 0, NULL, '', '', 0, '', 0, 1);
...
(24, 'BASE_URL', 'site url', 'S', 'S', NULL, 'http://localhost/rbs/', 'http://localhost/rbs/', 1255445949),
...
(1, '0', 'menoking', 'QTPros', 1, 'e10adc3949ba59abbe56e057f20f883e', 'menoking@gmail.com', NULL, 1, '', '', NULL, NULL, NULL, NULL, '', NULL, NULL, 1326535731, 1326616734, 0, 0, 0, 0, '0', '0'),
(2, '0', 'seller', 'seller', 2, 'e10adc3949ba59abbe56e057f20f883e', 'kiennguyen1101@gmail.com', '', 1, '', 'US', 'New York', 'New York', '', NULL, '', 0, NULL, 1326535764, 1327495518, 0, 0, 0, 0, '0', '0'),
(4, '0', 'buyer', 'Buyer', 1, 'e10adc3949ba59abbe56e057f20f883e', 'buyer@gmail.com', '', 1, '', 'US', 'New York', 'New York', '', NULL, '', NULL, NULL, 1326876869, 1327409769, 0, 0, 0, 0, '0', '0'),
(5, '0', 'buyer1', 'Buyer1', 1, 'e10adc3949ba59abbe56e057f20f883e', 'buyer1@gmail.com', '', 1, '', 'US', 'New York', 'New York', '', NULL, '', NULL, NULL, 1326876889, 1327543358, 0, 0, 0, 0, '0', '0'),
(6, '0', 'seller1', 'Seller1', 2, 'e10adc3949ba59abbe56e057f20f883e', 'seller1@gmail.com', NULL, 1, '', '', NULL, NULL, NULL, NULL, '', NULL, NULL, 1327112210, 1327112220, 0, 0, 0, 0, '0', '0');
